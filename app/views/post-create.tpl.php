            ...
            <div class="col-md-12">
                ...
                <form action="" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="excerpt" placeholder="Post excerpt" class="form-control" id="excerpt"
                            rows="2"><?= old('excerpt') ?></textarea>
                       <?= isset($validation) ? $validation->listErrors('excerpt') : '' ?>
                    </div>
                    <div class="mb-3">
                        <label for="content" class="form-label">Content</label>
                        <textarea name="content" class="form-control" placeholder="Post content" id="content"
